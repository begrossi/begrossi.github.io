  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Select your inquiry type and reach out directly. Response within 48 hours."
      />
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          <div>
            <div className="font-mono text-xs mb-3" style={{ color: "var(--fg-3)" }}>Email</div>
            <a
              href="mailto:bruno@grossi.com.br"
              className="text-lg font-light hover:text-[var(--accent)] transition-colors"
              style={{ color: "var(--fg)" }}
            >
              bruno@grossi.com.br
            </a>
        ...
        <div className="mt-12 border-l-2 pl-6" style={{ borderColor: "var(--line)" }}>
          <p className="text-sm" style={{ color: "var(--fg-3)" }}>
            For general inquiries, connect on LinkedIn. For speaking requests and advisory, email directly with a brief description of the opportunity and timeline.
          </p>
        </div>
      </div>
    </>
